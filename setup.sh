...
UE="inum" # nom de l'UE (= nom du dossier créé à la racine du compte)
CODE="IN" # code de l'UE = préfixe utilisé pour le token (= dossier secret)
DIRS="BONUS PROJET DST" # noms des sous-dossiers à créer
MAIL="miashs.inum@gmail.com" # adresse pour l'envoi du mail
